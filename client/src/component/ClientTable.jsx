  ...
  <div>
    <ul className="flex items-center justify-center space-x-2">
      <TooltipComponent content={"View"} position="TopCenter">
        <li className="w-8 h-8 rounded-full flex items-center justify-center bg-[#E3E7FF] text-[#465DFF] hover:bg-[#465DFF] hover:text-white transition-all duration-300 ease-in-out cursor-pointer">
          <FaEye />
        </li>
      </TooltipComponent>
